...
getPaymentTranslation,
getProductTranslation,
getTranslation
} from "./i18n/kioskI18n.js";
...
const API_URL = "/api";
const LANGUAGE_STORAGE_KEY = "kiosko_usil_language";
...
const KIOSK_TEXT = {
es: {
reviewOrder: "2. Revisa tu pedido",
confirmPaymentStep: "3. Confirma el pago",
pickupNumber: "4. Retira con tu número",
receipt: "Ver comprobante",
anotherOrder: "Realizar otro pedido",
status: "Estado",
addedToOrder: "agregado al pedido.",
noStockProduct: "Este producto no tiene stock disponible.",
noMoreStockPrefix: "No hay más stock disponible para",
noProductsToCancel: "No hay productos para cancelar.",
cancelCurrentConfirm: "¿Deseas cancelar el pedido actual y vaciar el carrito?",
...
emptyOrderShort: "Pedido vacío",
selected: "seleccionado",
selectedPlural: "seleccionados",
chooseProductsStart: "Elige productos del catálogo para iniciar tu pedido.",
close: "Cerrar",
mobilePayment: "Pago móvil",
debitCredit: "Débito / crédito",
fastScan: "Escaneo rápido",
scanQr: "Escanea el QR para simular el pago.",
payPrefix: "Pagar",
confirmPaymentWithTotal: "¿Confirmas el pago y el envío del pedido a cafetería?",
backHome: "Volver al inicio",
noStock: "Sin stock"
},
en: {
reviewOrder: "2. Review your order",
confirmPaymentStep: "3. Confirm payment",
pickupNumber: "4. Pick up with your number",
receipt: "View receipt",
anotherOrder: "Place another order",
status: "Status",
addedToOrder: "added to the order.",
noStockProduct: "This product is out of stock.",
noMoreStockPrefix: "No more stock is available for",
noProductsToCancel: "There are no products to cancel.",
cancelCurrentConfirm: "Do you want to cancel the current order and empty the cart?",
orderCancelled: "Order cancelled successfully.",
cartWarningBack:
"You have products in your cart. Do you want to go back to the start and cancel the order?",
loadingProducts: "Loading products...",
emptyOrderShort: "Empty order",
selected: "selected",
selectedPlural: "selected",
chooseProductsStart: "Choose products from the catalog to start your order.",
close: "Close",
mobilePayment: "Mobile payment",
debitCredit: "Debit / credit",
fastScan: "Quick scan",
scanQr: "Scan the QR code to simulate payment.",
payPrefix: "Pay",
confirmPaymentWithTotal: "Do you confirm payment and sending the order to the cafeteria?",
backHome: "Back to start",
noStock: "Out of stock"
},
fr: {
reviewOrder: "2. Vérifiez votre commande",
confirmPaymentStep: "3. Confirmez le paiement",
pickupNumber: "4. Récupérez avec votre numéro",
receipt: "Voir le reçu",
anotherOrder: "Passer une autre commande",
status: "Statut",
addedToOrder: "ajouté à la commande.",
noStockProduct: "Ce produit est en rupture de stock.",
noMoreStockPrefix: "Il n'y a plus de stock disponible pour",
noProductsToCancel: "Il n'y a aucun produit à annuler.",
cancelCurrentConfirm:
"Voulez-vous annuler la commande actuelle et vider le panier ?",
orderCancelled: "Commande annulée correctement.",
cartWarningBack:
"Vous avez des produits dans le panier. Voulez-vous revenir au début et annuler la commande ?",
loadingProducts: "Chargement des produits...",
emptyOrderShort: "Commande vide",
selected: "sélectionné",
selectedPlural: "sélectionnés",
chooseProductsStart: "Choisissez des produits du catalogue pour commencer.",
close: "Fermer",
mobilePayment: "Paiement mobile",
debitCredit: "Débit / crédit",
fastScan: "Scan rapide",
scanQr: "Scannez le QR pour simuler le paiement.",
payPrefix: "Payer",
confirmPaymentWithTotal:
"Confirmez-vous le paiement et l'envoi de la commande à la cafétéria ?",
backHome: "Retour au début",
noStock: "Rupture de stock"
},
nl: {
reviewOrder: "2. Controleer je bestelling",
confirmPaymentStep: "3. Bevestig de betaling",
pickupNumber: "4. Haal op met je nummer",
receipt: "Bon bekijken",
anotherOrder: "Nieuwe bestelling plaatsen",
status: "Status",
addedToOrder: "toegevoegd aan de bestelling.",
noStockProduct: "Dit product is niet op voorraad.",
noMoreStockPrefix: "Er is geen voorraad meer beschikbaar voor",
noProductsToCancel: "Er zijn geen producten om te annuleren.",
cancelCurrentConfirm:
"Wil je de huidige bestelling annuleren en de winkelwagen leegmaken?",
orderCancelled: "Bestelling succesvol geannuleerd.",
cartWarningBack:
"Je hebt producten in je winkelwagen. Wil je terug naar het begin en de bestelling annuleren?",
loadingProducts: "Producten laden...",
emptyOrderShort: "Lege bestelling",
selected: "geselecteerd",
selectedPlural: "geselecteerd",
chooseProductsStart: "Kies producten uit de catalogus om je bestelling te starten.",
close: "Sluiten",
mobilePayment: "Mobiele betaling",
debitCredit: "Debet / krediet",
fastScan: "Snelle scan",
scanQr: "Scan de QR-code om de betaling te simuleren.",
payPrefix: "Betalen",
confirmPaymentWithTotal:
"Bevestig je de betaling en het verzenden van de bestelling naar de cafetaria?",
backHome: "Terug naar start",
noStock: "Geen voorraad"
},
de: {
reviewOrder: "2. Bestellung prüfen",
confirmPaymentStep: "3. Zahlung bestätigen",
pickupNumber: "4. Mit Ihrer Nummer abholen",
receipt: "Beleg ansehen",
anotherOrder: "Weitere Bestellung aufgeben",
status: "Status",
addedToOrder: "zur Bestellung hinzugefügt.",
noStockProduct: "Dieses Produkt ist nicht auf Lager.",
noMoreStockPrefix: "Für dieses Produkt ist kein weiterer Bestand verfügbar:",
noProductsToCancel: "Es gibt keine Produkte zum Abbrechen.",
cancelCurrentConfirm:
"Möchten Sie die aktuelle Bestellung abbrechen und den Warenkorb leeren?",
orderCancelled: "Bestellung erfolgreich abgebrochen.",
cartWarningBack:
"Sie haben Produkte im Warenkorb. Möchten Sie zum Start zurückkehren und die Bestellung abbrechen?",
loadingProducts: "Produkte werden geladen...",
emptyOrderShort: "Leere Bestellung",
selected: "ausgewählt",
selectedPlural: "ausgewählt",
chooseProductsStart: "Wählen Sie Produkte aus dem Katalog, um zu beginnen.",
close: "Schließen",
mobilePayment: "Mobile Zahlung",
debitCredit: "Debit / Kredit",
fastScan: "Schneller Scan",
scanQr: "Scannen Sie den QR-Code, um die Zahlung zu simulieren.",
payPrefix: "Bezahlen",
confirmPaymentWithTotal:
"Bestätigen Sie die Zahlung und das Senden der Bestellung an die Cafeteria?",
backHome: "Zurück zum Start",
noStock: "Nicht auf Lager"
},
it: {
reviewOrder: "2. Controlla il tuo ordine",
confirmPaymentStep: "3. Conferma il pagamento",
pickupNumber: "4. Ritira con il tuo numero",
receipt: "Vedi ricevuta",
anotherOrder: "Effettua un altro ordine",
status: "Stato",
addedToOrder: "aggiunto all'ordine.",
noStockProduct: "Questo prodotto non è disponibile.",
noMoreStockPrefix: "Non c'è più disponibilità per",
noProductsToCancel: "Non ci sono prodotti da annullare.",
cancelCurrentConfirm: "Vuoi annullare l'ordine attuale e svuotare il carrello?",
orderCancelled: "Ordine annullato correttamente.",
cartWarningBack:
"Hai prodotti nel carrello. Vuoi tornare all'inizio e annullare l'ordine?",
loadingProducts: "Caricamento prodotti...",
emptyOrderShort: "Ordine vuoto",
selected: "selezionato",
selectedPlural: "selezionati",
chooseProductsStart: "Scegli prodotti dal catalogo per iniziare l'ordine.",
close: "Chiudi",
mobilePayment: "Pagamento mobile",
debitCredit: "Debito / credito",
fastScan: "Scansione rapida",
scanQr: "Scansiona il QR per simulare il pagamento.",
payPrefix: "Paga",
confirmPaymentWithTotal:
"Confermi il pagamento e l'invio dell'ordine alla caffetteria?",
...
const t = (key) => {
const globalTranslation = getTranslation(language, key);

if (globalTranslation !== key) {
  return globalTranslation;
}

return getKioskText(language, key);
...
return getProductTranslation(language, product);
};
...
setMessage("");
  ...
  if (!response.ok) {
    throw new Error(data.message || t("loadProductsError"));
  }

  setProducts(data.products || []);
} catch (error) {
  console.error(error);
  setMessage(t("loadProductsError"));
} finally {
  setLoading(false);
}
...
setCart((currentCart) => {
  ...
  if (existing) {
    if (existing.quantity >= product.stock) {
      setMessage(
        `${t("noMoreStockPrefix")} ${translatedProduct.translatedName}.`
      );
      return currentCart;
    }

    setMessage(`${translatedProduct.translatedName} ${t("addedToOrder")}`);
...
const cancelOrder = () => {
if (cart.length === 0) {
setMessage(t("noProductsToCancel"));
return;
}

const confirmed = window.confirm(t("cancelCurrentConfirm"));
...
const goToWelcome = () => {
if (cart.length > 0) {
const confirmed = window.confirm(t("cartWarningBack"));
...
const confirmed = window.confirm(
  `${t("confirmPaymentWithTotal")}\n${t("total")}: S/ ${formatCurrency(total)}`
);
...
try {
  ...
  if (!orderResponse.ok) {
    throw new Error(orderData.message || t("createOrderError"));
  }
  ...
  if (!paymentResponse.ok) {
    throw new Error(paymentData.message || t("paymentError"));
  }
  ...
  console.error(error);
  setMessage(error.message || t("processOrderError"));
} finally {
  setLoading(false);
}
...
maxWidth: isVerticalMode ? "800px" : "920px",
...
> <LanguageSelector
      ...
      >
        <div style={kioskStyles.step}>{t("stepChoose")}</div>
        <div style={kioskStyles.step}>{t("reviewOrder")}</div>
        <div style={kioskStyles.step}>{t("confirmPaymentStep")}</div>
        <div style={kioskStyles.step}>{t("pickupNumber")}</div>
      </div>
...
> <LanguageSelector
      ...
      <p style={kioskStyles.welcomeSubtitle}>{t("orderConfirmedText")}</p>
      ...
      {createdOrder && (
        <div style={kioskStyles.ticketBox}>
          ...
          <span>
            {t("total")}: S/ {formatCurrency(createdOrder.total)}
          </span>
          <span>
            {t("payment")}:{" "}
            {getPaymentTranslation(language, createdOrder.paymentMethod)}
          </span>
          <span>
            {t("status")}: {formatKioskStatus(language, createdOrder.status)}
          </span>
        </div>
      )}
...
<OfficialLogo size={isVerticalMode ? 64 : 78} mode="square" />
  ...
  >
    <section style={kioskStyles.productsArea}>
      ...
      {loading && <p style={kioskStyles.loadingText}>{t("loadingProducts")}</p>}
              ...
              {categoryProducts.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {getProductImage(product) ? (
                        <img
                          ...
                          alt={translatedProduct.translatedName}
                    ...
                    >
                      {product.stock <= 0 ? t("noStock") : t("add")}
                    </button>
                  </article>
                );
              })}
  ...
  {isVerticalMode && (
    <>
      ...
      {cartModalOpen && (
        <CartModal onClose={() => setCartModalOpen(false)} t={t}>
          {cartPanel}
        </CartModal>
      )}
    </>
...
function CartBottomBar({ total, totalItems, onOpen, disabled, t }) {
return ( <section style={kioskStyles.bottomBar}> <div> <strong style={kioskStyles.bottomBarTitle}>
{totalItems === 0
? t("emptyOrderShort")
: `${totalItems} ${totalItems === 1 ? t("item") : t("items")}`} </strong> <span style={kioskStyles.bottomBarTotal}>S/ {formatCurrency(total)}</span> </div>
...
function CartModal({ children, onClose, t }) {
return ( <div style={kioskStyles.modalOverlay}> <section style={kioskStyles.modalCard}> <div style={kioskStyles.modalHandle} />
...
> <div style={kioskStyles.cartHeader}> <div> <h2 style={kioskStyles.cartTitle}>{t("cart")}</h2> <p style={kioskStyles.cartSubtitle}>
{totalItems === 0
? t("emptyCart")
: `${totalItems} ${totalItems === 1 ? t("item") : t("items")} ${
                  totalItems === 1 ? t("selected") : t("selectedPlural")
                }.`} </p> </div>
  ...
  {cart.length === 0 ? (
    <p style={kioskStyles.emptyCart}>{t("chooseProductsStart")}</p>
  ) : (
    <div
      style={{
    ...
    >
      {cart.map((item) => {
        const translatedItem = getProductTranslation(language, item);

        return (
          <div key={item.id} style={kioskStyles.cartItem}>
            <div>
              <strong>{translatedItem.translatedName}</strong>
  ...
  <div style={kioskStyles.paymentBox}>
    <span style={kioskStyles.paymentLabel}>{t("paymentMethod")}</span>
      ...
      <div style={kioskStyles.selectedPaymentLeft}>
        {selectedPayment.image ? (
          <img
            ...
            alt={getPaymentTranslation(language, selectedPayment.value)}
        ...
        <div>
          <strong>
            {getPaymentTranslation(language, selectedPayment.value)}
          </strong>
          <span>{getPaymentDescription(language, selectedPayment.value)}</span>
        </div>
      </div>
    </div>
  )}
  ...
  {paymentMethod === "qr" && (
    <div style={kioskStyles.qrPreviewBox}>
      <img src={qrPagoImg} alt="QR" style={kioskStyles.qrPreview} />
      <span>{t("scanQr")}</span>
    </div>
  )}
  ...
  >
    {loading
      ? t("processing")
      : `${t("payPrefix")} S/ ${formatCurrency(total)}`}
  </button>
...
function PaymentSelector({ paymentMethod, setPaymentMethod, language, t }) {
return ( <div style={kioskStyles.paymentOptions}>
      ...
      >
        <span style={kioskStyles.paymentLogoBox}>
          {method.image ? (
            <img
              src={method.image}
              alt={getPaymentTranslation(language, method.value)}
        ...
        <span style={kioskStyles.paymentOptionText}>
          <strong>{getPaymentTranslation(language, method.value)}</strong>
          <small>{getPaymentDescription(language, method.value, t)}</small>
        </span>
      </button>
    );
  })}
...
const FLAG_STYLES = {
  ...
  en: {
    background:
      "linear-gradient(90deg, transparent 46%, #C8102E 46% 54%, transparent 54%), linear-gradient(0deg, transparent 42%, #C8102E 42% 58%, transparent 58%), linear-gradient(33deg, transparent 44%, #FFFFFF 44% 49%, #C8102E 49% 54%, #FFFFFF 54% 59%, transparent 59%), linear-gradient(147deg, transparent 44%, #FFFFFF 44% 49%, #C8102E 49% 54%, #FFFFFF 54% 59%, transparent 59%), #012169"
  },
  fr: {
    background:
      "linear-gradient(to right, #0055A4 0 33.33%, #FFFFFF 33.33% 66.66%, #EF4135 66.66% 100%)"
  },
  nl: {
    background:
      "linear-gradient(to bottom, #AE1C28 0 33.33%, #FFFFFF 33.33% 66.66%, #21468B 66.66% 100%)"
  },
  de: {
    background:
...
function LanguageSelector({ language, onChangeLanguage, centered = false }) {
  return (
    <section
      style={{
        ...kioskStyles.languageSelector,
        justifyContent: centered ? "center" : "flex-end",
        marginBottom: centered ? "20px" : 0
      }}
    >
      {LANGUAGES.map((item) => {
        ...
        return (
          <button
            ...
            type="button"
            style={{
              ...kioskStyles.languageButton,
              ...(isActive ? kioskStyles.languageButtonActive : {})
            }}
            onClick={() => onChangeLanguage(item.code)}
          >
            <span
              style={{
                ...kioskStyles.flagIcon,
                ...FLAG_STYLES[item.code]
              }}
            />
...
return ( <main style={adminStyles.page}> <header style={adminStyles.header}> <div style={adminStyles.headerBrand}> <OfficialLogo size={78} mode="square" />
...
return ( <section style={adminStyles.column}> <h2 style={adminStyles.columnTitle}>{title}</h2>
...
> <img src={image} alt="USIL" style={kioskStyles.officialLogoImage} /> </div>
);
}
...
if (LANGUAGES.some((language) => language.code === storedLanguage)) {
...
function getKioskText(language, key) {
return KIOSK_TEXT[language]?.[key] || KIOSK_TEXT.es[key] || key;
}

function getPaymentDescription(language, method) {
...
return getKioskText(language, descriptionKeys[method]) || method;
}

function formatKioskStatus(language, status) {
return STATUS_TRANSLATIONS[status]?.[language] || formatStatus(status);
}
...
gap: "6px",
cursor: "pointer",
boxShadow: "0 6px 16px rgba(11, 46, 107, 0.06)"
},
...
flagIcon: {
  ...
  height: "18px",
  borderRadius: "4px",
  border: "1px solid rgba(11, 46, 107, 0.18)",
